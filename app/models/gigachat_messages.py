...
from sqlalchemy import TIMESTAMP, Text, JSON
...
class GigachatMessage(Base):
    ...
    function_call: Mapped[dict | None] = mapped_column(JSONB, default=None)
    name: Mapped[str | None] = mapped_column(default=None)
    attachments: Mapped[dict | None] = mapped_column(JSONB, default=None)
    data_for_context: Mapped[dict | None] = mapped_column(JSONB, default=None)
