...
from app.utils.smtp import SMTP as SMTPConnection
from app.utils.password import generate_password, get_password_hash
...
async def api_create_user(
    ...
    user = await users_db.create(conn, data, hashed_password)
    if not user:
